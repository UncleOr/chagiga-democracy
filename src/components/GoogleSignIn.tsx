...
export function GoogleSignIn({ next }: { next?: string }) {
  ...
  return (
    <button onClick={signIn} disabled={loading} className="btn-ghost w-full py-3 text-base">
      <svg width="20" height="20" viewBox="0 0 48 48" aria-hidden>
        ...
        <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.5l6.3 5.3C41.6 36.2 44 30.6 44 24c0-1.3-.1-2.3-.4-3.5z" />
      </svg>
